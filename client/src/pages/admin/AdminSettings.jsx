...
const AdminSettings = () => {
  ...
  useEffect(() => {
    document.title = 'Admin Settings | Haven Realty';
  }, []);
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-slate-500">Manage your administrator account security</p>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="card mt-4 max-w-md space-y-4 p-6">
